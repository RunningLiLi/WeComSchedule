    ...
    <el-container>
      <el-header style="padding: 0;" class="el-header">
        <el-form :inline="true">
          <el-form-item label="教师姓名">
            <el-input v-model="name" placeholder="教师姓名"/>
          </el-form-item>
      ...
      <el-main style="padding: 0" class="el-main">
        ...
        >
          ...
          <el-table-column prop="xq" label="学期" align="center"/>
          <el-table-column prop="kcmc" label="课程名称" align="center"/>
          <el-table-column prop="jxbbh" label="教学班编号" align="center"/>
          <el-table-column prop="kcbh" label="课程编号" align="center"/>
          <el-table-column prop="js" label="教师"  align="center"/>
          <el-table-column prop="sjtbsj" label="数据同步时间" sortable align="center"/>
        </el-table>
      </el-main>
